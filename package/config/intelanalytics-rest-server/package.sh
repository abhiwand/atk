...
jarPath=$(find /home/root/.m2/repository/ch/qos/logback/ -name "logback-classic-1.1.1.jar")
cp -v $jarPath ${BUILD_DIR}/usr/lib/intelanalytics/rest-server/lib/
jarPath=$(find /home/root/.m2/repository/ch/qos/logback/ -name "logback-core-1.1.1.jar")
cp -v $jarPath ${BUILD_DIR}/usr/lib/intelanalytics/rest-server/lib/

...
class ExportFromTitanTest extends FlatSpec with Matchers with MockitoSugar {
  ...
  "javaTypeToIATType" should "get type from java type object" in {
    ExportFromTitanGraph.javaTypeToIATType(new java.lang.Integer(3).getClass) shouldBe int32
    ExportFromTitanGraph.javaTypeToIATType(new java.lang.Long(3).getClass) shouldBe int64
    ExportFromTitanGraph.javaTypeToIATType(new java.lang.Float(3.0).getClass) shouldBe float32
    ExportFromTitanGraph.javaTypeToIATType(new java.lang.Double(3).getClass) shouldBe float64
  }
}

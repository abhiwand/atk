 ...
 *  <code>edgePropertyTable</code> hash is keyed by edge id (src, dst, label) with
 *  the value being the property map. The <code>vertexNameToTitanID</code> is keyed
 *  by vertex id, which should be a <code>StringType</code> or <code>LongType</code>

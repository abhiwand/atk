...
import com.intel.taproot.analytics.domain.frame.{ FrameEntityType, FrameReference, FrameReferenceManagement }
import com.intel.taproot.analytics.domain.graph.{ GraphEntityType, GraphReference, GraphReferenceManagement }
...
import com.intel.taproot.analytics.engine.{ EntityTypeRegistry, ReferenceResolver }

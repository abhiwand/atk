...
/**
 * The type of an edge declaration used in graph construction. It encapsulates the label of the edge, 
 * as well as the names and datatypes of the properties that can be associated with edges of this type.
 *

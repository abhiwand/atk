...
public class GBUdfException extends Exception {
	...
	/**
	 * Constructs an <code>GBUdfException</code> with <code>null</code> as its error
	 * detail message.
	 */
	...
	/**
	 * Constructs an <code>GBUdfException</code> with the specified detail message.
	 * 
	 * @param message
    ...
    /**
     * Constructs an <code>GBUdfException</code> with the specified cause and a

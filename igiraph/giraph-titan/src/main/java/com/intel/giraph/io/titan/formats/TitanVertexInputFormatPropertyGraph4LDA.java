 ...
 * [1,[4,3],[d],[[2,2.1,[]],[3,0.7,[]]]]
 */
public class TitanVertexInputFormatPropertyGraph4LDA extends
        TitanVertexInputFormat<LongWritable,
                        VertexData4LDAWritable, DoubleWithVectorWritable> {

    private static final Logger LOG = Logger.getLogger(TitanVertexInputFormatPropertyGraph4LDA.class);
     ...
     */
    public static class PropertyGraph4LDAVertexReader extends TitanVertexReader<LongWritable, VertexData4LDAWritable, DoubleWithVectorWritable> {
        ...
        public boolean nextVertex() throws IOException, InterruptedException {
            while (getRecordReader().nextKeyValue()) {
                Vertex<LongWritable, VertexData4LDAWritable, DoubleWithVectorWritable>  tempGiraphVertex =

...
public class EdgeTest {
...

	{
		...
		StringType dst2 = new StringType("dst2");
		StringType label2 = new StringType("label2");
		Edge<StringType> edgeOnTheOtherEnd = new Edge<StringType>(src2, dst2,
				label2);
	...
	public void testEquals() {
		...
		Edge<StringType> edge0 = new Edge<StringType>(new StringType(
				"Employee001"), new StringType("Employee002"), new StringType(
				"isConnected"), map0);

		Edge<StringType> edge1 = new Edge<StringType>(new StringType(
				"Employee002"), new StringType("Employee003"), new StringType(
				"likes"), map1);

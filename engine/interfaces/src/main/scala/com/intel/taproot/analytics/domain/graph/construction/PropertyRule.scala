...
package com.intel.taproot.analytics.domain.graph.construction

/**
 * TapRootAnalytics V1 API Graph Loader rule for creating property graph properties from tabular data.

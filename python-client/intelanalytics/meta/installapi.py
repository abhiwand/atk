...
from intelanalytics.meta.names import get_type_name
from intelanalytics.meta.docstub import delete_docstubs, is_doc_stub
from intelanalytics.meta.clientside import client_commands, clear_clientside_api_stubs, is_api, ClientCommandDefinition
...
class ApiInfo(object):
    ...
    def __init__(self, obj):
        """obj should be the intelanalytics module, or some API object"""

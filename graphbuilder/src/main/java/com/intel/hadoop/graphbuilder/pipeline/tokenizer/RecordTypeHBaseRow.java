 ...
 * It has two parts:
 * <ul>
 *     <li><code>ImmutableBytesWritable row </code>  The hbase row.</li>
 *     <li><code>Result columns</code> The columns of the row.</li>
 * </ul>
...
public class RecordTypeHBaseRow {
     ...
     * @param row      The ImmutableBytesWriteable row.
     * @param columns  The Results columns of the row.
     */

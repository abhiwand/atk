...
public class TestJsonLongTwoVectorDoubleTwoVectorInputFormat extends JsonLongTwoVectorDoubleTwoVectorInputFormat {
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    conf = new ImmutableClassesGiraphConfiguration<LongWritable, TwoVectorWritable, DoubleWithTwoVectorWritable>(giraphConf);
 ...
 protected TextVertexReader createVertexReader(
  ...
  public void testReadVertex() throws Exception {
    ...
    Vertex<LongWritable, TwoVectorWritable, DoubleWithTwoVectorWritable>
  ...
  TwoVectorWritable, DoubleWithTwoVectorWritable, Writable> { }
}

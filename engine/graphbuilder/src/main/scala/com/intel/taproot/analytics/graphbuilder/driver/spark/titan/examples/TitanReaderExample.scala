...
package com.intel.taproot.analytics.graphbuilder.driver.spark.titan.examples
...
object TitanReaderExample {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // Remember to import com.intel.taproot.analytics.graphbuilder.driver.spark.rdd.GraphBuilderRDDImplicits._ to access filter methods

...
object IATPregel {
   ...
   *
   */
  def apply[VD: ClassTag, ED: ClassTag, A: ClassTag, VI: ClassTag, EI: ClassTag, S: ClassTag]
  (graph: Graph[VD, ED], initialMsg: A, pregelLogger: IATPregelLogger[VD, VI, ED, EI, S],
   maxIterations: Int = Int.MaxValue,  activeDirection: EdgeDirection = EdgeDirection.Either)(vprog: (VertexId, VD, A) => VD,

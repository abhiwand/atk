 ...
 *
 * <ul>
 * <li> It provides a handle to the mapper class used to read hbase tables (<code>HBaseReaderMapper</code>).</li>
...
public class HBaseInputConfiguration implements InputConfiguration {
    ...
    /**
     * Allocates and acquires an instance of the singleton <code>HBaseUtils</code>.
     */
     ...
     * @return HBaseReaderMapper.class
     * @see HBaseReaderMapper
     */

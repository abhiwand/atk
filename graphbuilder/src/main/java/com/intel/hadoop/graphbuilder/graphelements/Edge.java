 ...
 * <p>
 * This class is mutable. See the <code>configure</code> and <code>setProperty</code>
 * methods.
 * </p>
 *
...
public class Edge<VidType extends WritableComparable<VidType>>  extends GraphElement implements Writable {
    ...
    /**
     * Tell the callee that this <code>GraphElement</code> is an edge.
     * @return true
     */
    @Override
    ...
    /**
     * Tell the callee that this <code>GraphElement</code> is not a vertex.
     * @return false
     */
    @Override
     ...
     *
     * @param key The lookup key for the value in the edge's
	 * property map.
     * @param val The value to add to the property map (if the
     ...
     *
     * A deep calculation that combines the hash of the  source, destination

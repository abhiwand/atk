...
public class TestJsonLongIDTwoVectorValueOutputFormat extends JsonLongIDTwoVectorValueOutputFormat {
  /** Test configuration */
  ...
  public static class DummyComputation extends NoOpComputation<LongWritable,
      TwoVectorWritable, Writable, Writable> { }

  @Before
  public void setUp() {
    GiraphConfiguration giraphConfiguration = new GiraphConfiguration();
    giraphConfiguration.setComputationClass(DummyComputation.class);
    conf = new ImmutableClassesGiraphConfiguration<LongWritable, TwoVectorWritable, Writable>(giraphConfiguration);
  }
  ...
  private void JsonLongIDTwoVectorValueOutputFormatTestWorker(Text expected)

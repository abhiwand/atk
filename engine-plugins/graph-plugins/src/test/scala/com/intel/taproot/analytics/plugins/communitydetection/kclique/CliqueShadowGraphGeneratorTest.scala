...
import com.intel.taproot.analytics.plugins.communitydetection.kclique.datatypes.{ Clique, CliqueExtension, VertexSet }
import com.intel.taproot.analytics.plugins.communitydetection.kclique.datatypes.Clique

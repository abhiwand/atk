...
case class GetDataFrame(id: Long, name: String, ia_uri: String, schema: Schema, rowCount: Option[Long], links: List[RelLink], errorFrameId: Option[Long], commandPrefix: String) {

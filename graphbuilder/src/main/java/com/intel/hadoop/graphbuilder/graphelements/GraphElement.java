...
public abstract class GraphElement<VidType extends WritableComparable<VidType>> {
    ...
    /**
     * Calls the edge or vertex <code>GraphElementTypeCallback</code>.
     *
     * @see com.intel.hadoop.graphbuilder.graphelements.callbacks.GraphElementTypeCallback
     *
     * @param graphElementTypeCallback  Any instance of
	 *                                         <code>GraphElementTypeCallback</code>.
     * @param args                     The variable length of arguments that

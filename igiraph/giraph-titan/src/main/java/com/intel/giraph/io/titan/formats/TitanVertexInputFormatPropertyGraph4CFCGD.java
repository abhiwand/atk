 ...
 */
public class TitanVertexInputFormatPropertyGraph4CFCGD extends
        TitanVertexInputFormat<LongWritable, VertexData4CGDWritable, EdgeData4CFWritable> {

    private static final Logger LOG = Logger.getLogger(TitanVertexInputFormatPropertyGraph4CFCGD.class);

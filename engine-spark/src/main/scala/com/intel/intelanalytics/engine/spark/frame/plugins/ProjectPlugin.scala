...
class ProjectPlugin extends SparkCommandPlugin[FrameProject, DataFrame] {
   ...
   */
  override def execute(invocation: SparkInvocation, arguments: FrameProject, returnValue: Option[DataFrame])(implicit user: UserPrincipal, executionContext: ExecutionContext): DataFrame = {

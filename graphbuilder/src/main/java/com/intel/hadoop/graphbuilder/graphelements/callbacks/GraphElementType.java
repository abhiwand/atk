...
public class GraphElementType implements GraphElementTypeCallback {
    ...
    /**
     * Returns the edge's enum type. Although the <code>graphElement</code> and arguments
    ...
    /**
     * Returns the vertex enum type. Although the <code>graphElement</code> and
	 * <code>arguments</code> are not used here, they must be part of the

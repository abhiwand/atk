...
case class PrincipalComponentsPredictArgs(@ArgDoc("""Handle to the model to be used.""") model: ModelReference,
                                          ...
                                          @ArgDoc(
                                            """List of observation column name(s) to be used for prediction.
                                              |Default is the list of column name(s) used to train the model.
                                            """.stripMargin) observationColumns: Option[List[String]] = None,
                                          @ArgDoc(
                                            """The number of principal components to be predicted.
                                              |Default is the count used to train the model.
                                            """.stripMargin) c: Option[Int] = None,
                                          @ArgDoc(
                                            """Indicator for whether the t-square index is to be computed.
                                              |Default is false.
                                            """.stripMargin) tSquareIndex: Option[Boolean] = None,

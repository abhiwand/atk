...
// */
//class RandomForestNewPlugin extends SparkCommandPlugin[GenericNewModelArgs, ModelEntity] {
//  /**
...
//   */
//  override def name: String = "model:random_forest/new"
//
//  override def execute(arguments: GenericNewModelArgs)(implicit invocation: Invocation): ModelEntity = {
//    engine.models.createModel(CreateEntityArgs(name = arguments.name, entityType = Some("model:random_forest")))
//  }
//}
//

 ...
 * <code>SerializedGraphElement.graphElement().getType()</code>
 * <b>without interface</b>
 * <code>((Edge)SerializedGraphElement.graphElement()).getType()</code>
 * </p>
 * <p/>
 * <p>The interface gets called from <code>GraphElement.typeCallback</code>.</p>
 * <pre>
 * <code>

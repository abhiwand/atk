...
DEFINE CreatePropGraphElements com.intel.pig.udf.eval.CreatePropGraphElements('-v employee_id=name,age,dept manager -d employee_id,manager,worksUnder,underManager" -P');
...
STORE_GRAPH(merged, '$GB_HOME/examples/hbase-titan-conf.xml', 'name:String,age:Integer,dept:String,underManager:String', 'worksUnder,underManager', '-O -P');

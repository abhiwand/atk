...
/**
 * Pig 0.11.1 piggybank also has a CSVExcelStorage class, but that class doesn't have the SKIP_INPUT_HEADER option
 * That's why we package this old version of CSVExcelStorage from piggybank that can skip the header line of CSV files.
 */

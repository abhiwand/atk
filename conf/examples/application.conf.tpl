# This (application.conf.tpl) is a configuration template for the TapRoot Analytics Toolkit.
...
intel.taproot.analytics {
  engine {
    auto-partitioner {
        ...
        # to increase Spark driver memory, edit java options (IA_JVM_OPT) in /etc/default/taprootanalytics-rest-server
        broadcast-join-threshold = "512MB"
    }
  }

  # Configuration for the TapRoot Analytics REST server
  api {
    ...
    titan {
      ...
      query {
        ...
        cache {
          ...
          # Either increase heap allocation for TapRootAnalytics Engine, or reduce db-cache-size

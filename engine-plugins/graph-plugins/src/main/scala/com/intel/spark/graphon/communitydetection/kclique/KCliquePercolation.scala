...
case class KCliqueArgs(graph: GraphReference,
            ...
            |Must be at least +2.""".stripMargin) cliqueSize: Int,
            ...
            |vertex.""".stripMargin) communityPropertyLabel: String) {
...
@PluginDoc(oneLine = "Find groups of vertices with similar attributes.",
  extended = """Notes
    ...
    |result is written out.""".stripMargin,
  returns = """Execution time.""".stripMargin
)

...
/**
 * GiraphVertexLoaderLongLongNull loads vertex
 * with <code>Long</code> vertex ID's,
 * <code>Long</code> vertex values,
 * and <code>Null</code> edge weights.
 */
public class GiraphVertexLoaderLongLongNull {

    /**
     * Class logger.
     */
    private static final Logger LOG = Logger.getLogger(GiraphVertexLoaderLongLongNull.class);
    /**
     ...
     * Giraph Vertex
     */
    private Vertex<LongWritable, LongWritable, NullWritable> vertex = null;
    /**

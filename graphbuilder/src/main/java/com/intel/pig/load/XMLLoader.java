...
/**
 * 
 * GraphBuilder version of Piggy Bank's XMLLoader with improved memory management
 * 
...
public class XMLLoader extends LoadFunc {
	...
	/**
	 * The record separator. The default value is 'document'
	 */
	 ...
	 * separator. For example, if the recordIdentifier is document, it will

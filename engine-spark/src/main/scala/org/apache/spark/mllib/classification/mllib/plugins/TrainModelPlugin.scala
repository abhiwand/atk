  ...
  override def execute(arguments: ModelLoad)(implicit invocation: Invocation): UnitReturn =
    {
      ...
      val updatedTrainRDD = inputFrame.data.selectColumns(List(arguments.labelColumn, arguments.observationColumn))
      val labeledTrainRDD: RDD[LabeledPoint] = createLabeledRDD(inputFrame.data, arguments.labelColumn, List(arguments.observationColumn))

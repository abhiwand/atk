...
class TestProgressReportStrategy(unittest.TestCase):
    ...
    def test_start_with_1_job(self):
    ...
    def test_start_with_1_job_in_list(self):
        self.progressReportStrategy = ProgressReportStrategy()
        self.assertEquals(1, len(self.progressReportStrategy.getAllMapReduceJobsProgressList()))

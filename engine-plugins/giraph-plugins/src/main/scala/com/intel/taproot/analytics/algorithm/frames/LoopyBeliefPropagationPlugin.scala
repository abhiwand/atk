...
import com.intel.taproot.analytics.giraph.algorithms.lbp.LoopyBeliefPropagationComputation
import com.intel.taproot.analytics.giraph.algorithms.lbp.LoopyBeliefPropagationComputation.{ LoopyBeliefPropagationAggregatorWriter, LoopyBeliefPropagationMasterCompute }
import com.intel.taproot.analytics.giraph.lbp._
...
We currently support **Label Propagation (LP)** and **Loopy Belief Propagation (LBP)**.

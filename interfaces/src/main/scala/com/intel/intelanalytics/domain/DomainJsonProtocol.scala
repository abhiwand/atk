...
object DomainJsonProtocol extends IADefaultJsonProtocol {
  ...
  implicit val columnSummaryStatisticsReturnFormat = jsonFormat10(ColumnSummaryStatisticsReturn)
  implicit val columnFullStatisticsFormat = jsonFormat3(ColumnFullStatistics)
  implicit val columnFullStatisticsReturnFormat = jsonFormat12(ColumnFullStatisticsReturn)

...
public class TestJsonPropertyGraph4LDAOutputFormat extends JsonPropertyGraph4LDAOutputFormat {
    /** Test configuration */
    private ImmutableClassesGiraphConfiguration<LongWritable, VertexData4LDAWritable, Writable> conf;
    /**
     * Dummy class to allow ImmutableClassesGiraphConfiguration to be created.
     */
    public static class DummyComputation extends NoOpComputation<LongWritable, VertexData4LDAWritable, Writable,
        Writable> { }
    ...
    public void testOuputFormat() throws IOException, InterruptedException {
        ...
        JsonLongIDVertexData4LDAWriter writer = new JsonLongIDVertexData4LDAWriter() {
            @Override

 ...
 *
 * <p>
 * This class is mutable. See the <code>configure</code> and <code>setProperty</code> methods.
 * </p>
 *
...
public class Vertex<VidNameType extends WritableComparable<VidNameType>>
    ...
    /**
     * Create a vertex with name, label (as a <code>String</code>), and property map
     *
     * @param name vertex nam
     * @param label vertex label as a <code>String</code>
     * @param propertyMap a property map
     *
     */
     ...
     *
     * @param name vertex nam
     * @param label vertex label as a <code>StringType</code>
     */
    ...
    /**
     * This <code>GraphElement</code> is not an edge.
     * @return false
     */
    @Override
    ...
    /**
     * This <code>GraphElement</code> is a vertex.
     * @return true
     */
    @Override
    ...
    /**
     * Is this <code>GraphElement</code> null?
     * @return  true if the <code>VertexID</code> is null
     */
    @Override
     ...
     * @param properties  The new PropertyMap.
     */
    ...
    /**
     * Check if the <code>Vertex</code> is equal to the input <code>Object</code>
     *
     * <p>This is a deep check: Source, destination
     * vertex ID's and all properties are checked to decide
     * equality.
     * </p>
     * @param object being tested against against the <code>Vertex</code> for equality.
     */
    @Override

...
class DropDuplicatesPlugin extends SparkCommandPlugin[DropDuplicates, DataFrame] {
   ...
   */
  override def execute(invocation: SparkInvocation, arguments: DropDuplicates, returnValue: Option[DataFrame])(implicit user: UserPrincipal, executionContext: ExecutionContext): DataFrame = {

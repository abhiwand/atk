 ...
 */
  ...
  val cumSumDoc = CommandDoc(oneLineSummary = "Cumulative sum.",
    extendedSummary = Some("""
  ...
  val entropyDoc = CommandDoc(oneLineSummary = "Column Shannon entropy.",
    extendedSummary = Some("""
...
|
  ...
  val topKDoc = CommandDoc(oneLineSummary = "Top/bottom) K distinct values.",
    extendedSummary = Some("""

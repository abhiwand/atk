...
class SparkEngine(sparkContextManager: SparkContextManager,
  ...
  val assignSampleCommand = commands.registerCommand("dataframe/assign_sample", assignSampleSimple, doc = Some(assignSampleDoc))
...
*/
  ...
  val columnStatisticCommand: CommandPlugin[ColumnSummaryStatistics, ColumnSummaryStatisticsReturn] =
    commands.registerCommand("dataframe/column_summary_statistics", columnStatisticSimple, doc = Some(columnSummaryStatisticsDoc))
 ...
 */
  ...
  val removeColumnCommand = commands.registerCommand("dataframe/remove_columns", removeColumnSimple _, doc = Some(removeColumnDoc))

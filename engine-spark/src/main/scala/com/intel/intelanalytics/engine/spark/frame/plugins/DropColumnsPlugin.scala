...
class DropColumnsPlugin extends SparkCommandPlugin[FrameDropColumns, DataFrame] {
   ...
   */
  override def execute(invocation: SparkInvocation, arguments: FrameDropColumns, returnValue: Option[DataFrame])(implicit user: UserPrincipal, executionContext: ExecutionContext): DataFrame = {

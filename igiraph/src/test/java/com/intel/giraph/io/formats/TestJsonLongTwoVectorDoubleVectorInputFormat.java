...
public class TestJsonLongTwoVectorDoubleVectorInputFormat extends JsonLongTwoVectorDoubleVectorInputFormat {
  ...
  public void setUp() throws IOException, InterruptedException {
    ...
    conf = new ImmutableClassesGiraphConfiguration<LongWritable, TwoVectorWritable, DoubleWithVectorWritable>(giraphConf);
 ...
 protected TextVertexReader createVertexReader(
  ...
  public void testReadVertex() throws Exception {
    ...
    Vertex<LongWritable, TwoVectorWritable, DoubleWithVectorWritable>
  ...
  TwoVectorWritable, DoubleWithVectorWritable, Writable> { }
}

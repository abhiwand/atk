...
class BigDataFrame(object):
    ...
    def apply(self, col_name, func, output_type):
    ...
    def applymap(self, col_name, func, output_type):
        """
...
#
    ...
    def fillna(self, col_name, value):
        """
    ...
    #def replace(self, col_name, to_replace):
        #"""
        #Parameters
        #----------
        #col_name : String

...
class PercentileCalculationTest extends FlatSpec with Matchers {
  "25th percentile" should "be 0.5 * x2 + 0.5 * x3 from 10 elements" in {
    Seq(PercentileComposingElement(2, 0.5f), PercentileComposingElement(3, 0.5f)) shouldBe SparkOps.getPercentileComposingElements(10, 25)
  }

  "0th percentile" should "be 1 * x1 + 0 * x2 from 5260980 elements" in {
    Seq(PercentileComposingElement(1, 1)) shouldBe SparkOps.getPercentileComposingElements(5260980, 0)
  }

  "95th percentile" should "be 1 * x4997931 + 0 * x4997932 from 5260980 elements" in {
    Seq(PercentileComposingElement(4997931, 1)) shouldBe SparkOps.getPercentileComposingElements(5260980, 95)
  }

  "99st percentile" should "be 1 * x4997931 + 0 * x4997932 from 5260980 elements" in {
    Seq(PercentileComposingElement(5208370, 0.8f), PercentileComposingElement(5208371, 0.2f)) shouldBe SparkOps.getPercentileComposingElements(5260980, 99)
  }

  "100th percentile" should "be 1 * x1 + 0 * x2 from 5260980 elements" in {
    Seq(PercentileComposingElement(5260980, 1)) shouldBe SparkOps.getPercentileComposingElements(5260980, 100)
  }

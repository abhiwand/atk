...
class PandasFrame(object):
    ...
    def field_names(self):
        ...
        List of field names from the schema stored in the intelanalytics pandas dataframe object
        ...
        It will have two columns *col1* and *col2* with types of *int32* and *float32* respectively::
            ...
            my_pandas = ia.PandasFrame(your_pandas, schema=[("col1", ia.int32), ("col2", ia.float32)])
    ...
    def field_types(self):
        ...
        List of field types from the schema stored in the intelanalytics pandas dataframe object.

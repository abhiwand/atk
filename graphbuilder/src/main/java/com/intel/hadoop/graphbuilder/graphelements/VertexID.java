 ...
 *
 * <p>
 * It is used in the initial reducer of an <code>GraphGenerationJob</code>to detect and handle duplicate edges.
...
public class VertexID<VidType extends WritableComparable> implements WritableComparable<VertexID<VidType>> {
    ...
    /**
     * Construct <code>VertexID</code> from parameters.
     * @param name The <code>VidType</code> vertex name
     * @param label  The <code>String</code> vertex label
     */
    ...
    /**
     * Equality test: Is the other object a <code>VertexID</code> whose components are equal to those of this vertexID?
     *
     * Because the <code>equals</code> method of the underlying <code>StringType</code> type for <code>label</code> and <code>name</code>
     * depends only upon the equality of the underlying strings, the <code>equals</code> method <code>VertexID</code> depends only
     * upon the string equality of the labels and names.
     * @param obj  Any object.
     * @return   true if the object is a VertexID of value equal to the current <code>VertexID</code>,
     * false otherwise
     */
    @Override
    ...
    /**
     * Hash of the VertexID is determined by the label/name pair as <code>StringType</code> objects.
     *
     * Because hash codes of <code>StringType</code> objects depend only upon underlying string value, the hashcode of a
     * <code>VertexID</code> depends only on the underlying string values of its label and name.
     *
    ...
    /**
     * @return a string representation of the <code>VertexID</code>
     */
    @Override

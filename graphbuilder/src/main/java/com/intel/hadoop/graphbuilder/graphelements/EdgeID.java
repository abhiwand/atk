 ...
 *
 * <p>
 * This class is used in the initial reducer of an <code>GraphGenerationJob</code> to detect
...
public class EdgeID {
    ...
    /**
     * Construct <code>EdgeID</code> from parameters.
    ...
    /**
     * Equality test: Is the other object an <code>EdgeID</code> whose components are the same objects as this one?

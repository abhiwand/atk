...
The graph machine learning algorithms in the |TA| use the Giraph
...
#.  Limit the Giraph memory allocation in application.conf to match the
    ...
    The relevant settings in the |TA| application.conf file are in

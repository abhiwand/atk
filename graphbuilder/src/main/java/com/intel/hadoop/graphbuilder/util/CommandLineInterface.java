...
public class CommandLineInterface{
    ...
    /**
     * A wrapper to the regular <code>hasOption</code> command line class.
    ...
    /**
     * A wrapper to the regular <code>getOptionValue</code> command line class.
     ...
     * @param job The <code>GraphConstructionPipeline</code> (hadoop) job to which we will attach our config.
     * @return The same <code>GraphConstructionPipeline</code> (hadoop) job with our config.
     */
    ...
    /**
     * Parses the raw arguments into a <code>CommandLine</code> object.
     * @param args The raw command line arguments as a string array.
     * @return  A nicely packaged <code>CommandLine</code> object.
     */
     ...
     * @param message The error message to display on the command line.
     */
     ...
     * @param option The option that should be in the <code>MissingOptionException.

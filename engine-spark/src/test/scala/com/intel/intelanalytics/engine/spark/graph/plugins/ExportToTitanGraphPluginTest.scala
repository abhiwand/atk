  ...
  "ExportToTitanGraph" should {
    ...
    "unallowed titan naming elements will throw proper exceptions" in {
      intercept[IllegalArgumentException] {
        ...
        val frame1 = new FrameEntity(1, "name", edgeSchema1, 0L, new DateTime, new DateTime)
        ...
        val frame2 = new FrameEntity(1, "name", edgeSchema2, 0L, new DateTime, new DateTime)
        ...
        val frame3 = new FrameEntity(1, "name", edgeSchema3, 0L, new DateTime, new DateTime)
    ...
    "no exception thrown if titan naming elements are valid" in {
      val frame1 = new FrameEntity(1, "name", edgeSchema, 0L, new DateTime, new DateTime, graphId = Some(1L))
      ...
      val frame2 = new FrameEntity(1, "name", edgeSchema2, 0L, new DateTime, new DateTime, graphId = Some(1L))

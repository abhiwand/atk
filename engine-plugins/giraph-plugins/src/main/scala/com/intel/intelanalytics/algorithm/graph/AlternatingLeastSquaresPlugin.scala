...
If more than one edge property is used, this str is a comma-separated list of property names.""")
                                   edgeValuePropertyList: List[String],
                                   @ArgDoc("""Name of edge label.""")
...
Vertices must have a property to identify them as either left-side (\"L\") or right-side (\"R\").""")

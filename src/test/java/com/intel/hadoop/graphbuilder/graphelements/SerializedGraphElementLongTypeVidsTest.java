...
public class SerializedGraphElementLongTypeVidsTest {
	...
	public void testCompareTo() {
		...
		Vertex<LongType> vertex0 = new Vertex<LongType>(new LongType(001L),
		...
		Vertex<LongType> vertex1 = new Vertex<LongType>(new LongType(002L),
		...
		Vertex<LongType> vertex2 = new Vertex<LongType>(new LongType(001L),
				new StringType("IntelEmployee"), map0);
		...
		Edge<LongType> edge0 = new Edge<LongType>(new LongType(001L), null,
				new LongType(002L), null, new StringType("isConnected"), map0);

		SerializedGraphElementLongTypeVids element4 = new SerializedGraphElementLongTypeVids();
		element4.init(edge0);

		Edge<LongType> edge1 = new Edge<LongType>(new LongType(003L), null,
				new LongType(004L), null, new StringType("isConnected"), map1);
		...
		Edge<LongType> edge2 = new Edge<LongType>(new LongType(001L), null,
				new LongType(002L), null, new StringType("isConnected"), map0);

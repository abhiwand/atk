...
//}
//
//class RandomForestRegressorTrainPlugin extends SparkCommandPlugin[RandomForestRegressorTrainArgs, UnitReturn] {
//  /**
...
//   */
//  override def name: String = "model:random_forest/train_regressor"
//
...
//   */
//  override def execute(arguments: RandomForestRegressorTrainArgs)(implicit invocation: Invocation): UnitReturn = {

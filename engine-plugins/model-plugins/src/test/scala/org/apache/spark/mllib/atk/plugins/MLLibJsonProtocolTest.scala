...
class MLLibJsonProtocolTest extends WordSpec {
  ...
  "NodeFormat" should {
    ...
    "be able to serialize" in {
      ...
      assert(node.toJson.compactPrint == "{\"id\":1,\"predict\":{\"predict\":0.1,\"prob\":0.2},\"impurity\":0.2,\"isLeaf\":false,\"split\":{\"feature\":2," +
        "\"threshold\":0.5,\"featuretype\":{\"featuretype\":\"Categorical\"},\"categories\":[1.1,2.2]},\"leftNode\":{\"id\":2,\"predict\":{\"predict\":" +
        "0.3,\"prob\":0.4},\"impurity\":0.5,\"isLeaf\":true,\"split\":{\"feature\":2,\"threshold\":0.5,\"featuretype\":{\"featuretype\":\"Categorical\"}," +
        "\"categories\":[1.1,2.2]},\"leftNode\":null,\"rightNode\":null,\"stats\":null},\"rightNode\":null,\"stats\":null}")
    }

    "parse json" in {
//      val string = "{\"id\":1,\"predict\":{\"predict\":0.1,\"prob\":0.2},\"impurity\":0.2,\"isLeaf\":false,\"split\":{\"feature\":2," +
//        "\"threshold\":0.5,\"featuretype\":{\"featuretype\":\"Categorical\"},\"categories\":[1.1,2.2]},\"leftNode\":{\"id\":2,\"predict\":{\"predict\":" +
//        "0.3,\"prob\":0.4},\"impurity\":0.5,\"isLeaf\":true,\"split\":{\"feature\":2,\"threshold\":0.5,\"featuretype\":{\"featuretype\":\"Categorical\"}," +
//        "\"categories\":[1.1,2.2]},\"leftNode\":null,\"rightNode\":null,\"stats\":null},\"rightNode\":null,\"stats\":null}"
      val string =
...
//      """
//        |{
//        |"topnode":{"id":1,"predict":{"predict":0.1,"prob":0.2},"impurity":0.2,"isLeaf":true,"split":null,"leftNode":null,"rightNode":null,"stats":null},
//        |"algo":"Classification"
//        |}
//      """.stripMargin
//      val json = JsonParser(string).asJsObject

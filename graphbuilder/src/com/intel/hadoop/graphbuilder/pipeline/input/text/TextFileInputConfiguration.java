...
/**
 * The methods in this class are used by the full Map Reduce chain to properly  
 * configure the first Map Reduce job to work with the {@code TextParsingMapper}.
 *
 * Called when setting up the first Map Reduce job of a chain,

...
case class SVMTrainArgs(model: ModelReference,
  ...
  require(numIterations != None, "numIterations must not be None")
  require(stepSize != None, "stepSize must not be None")
  require(regParam != None, "regParam must not be None")
  require(regType != None, "regType must not be None")
}
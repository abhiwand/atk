...
package org.trustedanalytics.atk.algorithm.frames
...
import org.trustedanalytics.atk.giraph.cf._
import org.trustedanalytics.atk.algorithm.util.{ GiraphConfigurationUtil, GiraphJobManager }
...
`Large-Scale Parallel Collaborative Filtering for the Netflix Prize <http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.173.2797>`__ , 2008.

...
package com.intel.spark.graphon.graphxutilities
 ...
 */
private[graphon] class OpenHashSet[@specialized(Long, Int) T: ClassTag](
  initialCapacity: Int,
  loadFactor: Double)
  ...
  import com.intel.spark.graphon.graphxutilities.OpenHashSet._
...
private[graphon] object OpenHashSet {

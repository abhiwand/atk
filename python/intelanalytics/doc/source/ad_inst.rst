...
The installation of the Intel® Analytics package relies upon other programs to function properly.
During installation these other packages are checked for and installed if absent:

 ...
 */
public class TitanVertexInputFormatPropertyGraph4LBP extends
        TitanVertexInputFormat<LongWritable, VertexData4LBPWritable, DoubleWritable> {

    private static final Logger LOG = Logger.getLogger(TitanVertexInputFormatPropertyGraph4LBP.class);

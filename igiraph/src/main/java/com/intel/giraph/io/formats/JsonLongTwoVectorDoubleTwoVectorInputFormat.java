...
/**
  ...
  * JSON format.
  */
public class JsonLongTwoVectorDoubleTwoVectorInputFormat extends TextVertexInputFormat<LongWritable,
    TwoVectorWritable, DoubleWithTwoVectorWritable> {
    ...
    class JsonLongTwoVectorDoubleTwoVectorReader extends
        ...
        @Override
        protected Iterable<Edge<LongWritable, DoubleWithTwoVectorWritable>> getEdges(JSONArray jsonVertex)
            ...
            for (int i = 0; i < jsonEdgeArray.length(); ++i) {
                ...
                edges.add(EdgeFactory.create(new LongWritable(jsonEdge.getLong(0)),
                    new DoubleWithTwoVectorWritable(jsonEdge.getDouble(1), vector.clone(), vector.clone())));
            }
            return edges;
        }

        @Override
        protected Vertex<LongWritable, TwoVectorWritable, DoubleWithTwoVectorWritable> handleException(Text line,

...
class BigFrame(CommandSupport):
    ...
    def split_data(self, name):
        ...
        output_column : The name of the new column which holds the labels generated by the Optional. Defaults to "sample bin".
        ...
        # Now my_frame has a column named "sample bin" and each row contains one of the values "train", "test",
         or "validate" in column sample_bin
        """
        pass

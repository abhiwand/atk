...
object Dependencies {
   ...
   */
  def getComputables[A <: Product](arguments: A)(implicit s: Searchable[A, UriReference]) : Seq[Computable] = {
   ...
   */
  private def buildHelper(startWith: Seq[Computable], resolver: ReferenceResolver, accumulator : List[Set[Command]])
  : List[Set[Command]] = {

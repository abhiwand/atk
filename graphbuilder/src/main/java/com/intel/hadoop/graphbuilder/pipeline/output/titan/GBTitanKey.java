...
public class GBTitanKey {
     ...
     * <p> Default values:
     * <ul>
     *     <li> <code>dataType</code>      : <code>String.class</code></li>
     *     <li> <code>isEdgeIndex</code>   : <code>false</code></li>
     *     <li> <code>isVertexIndex</code> : <code>false</code></li>
     *     <li> <code>isUnique</code>      : <code>false</code></li>
     * </ul></p>
     * @param name  The name of the property being associated with this Titan key.
     */
     ...
     * @param name The name of the Titan key to set.
     */
     ...
     * @return The key's datatype, a <code>Class<?></code> object.
     */
     ...
     * @param dataType The key's datatype, a Class<?> object.
     */
     ...
     * @return true If, and only if, the key is used for edge indexing.
     */
     ...
     * @param isEdgeIndex true If, and only if, the key is to be used for edge indexing.
     */
     ...
     * @return true If, and only if, the key is to be used for vertex indexing.
     */
     ...
     * @param isVertexIndex true If, and only if, the key is to be used for vertex indexing.
     */
     ...
     * @return true If the key takes values that are unique per vertex.
     */
     ...
     * @param isUnique true If the key takes values that are unique per vertex.
     */

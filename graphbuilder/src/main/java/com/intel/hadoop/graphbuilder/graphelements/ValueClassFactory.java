...
/**
 * A Factory class that creates a concrete <code>SerializedGraphElement</code>
 * which is used in <code>TextGraphMR</code> as the intermediate value type.
 */
public class ValueClassFactory {

    /**
     * @param vidClassName  The name of the vertex ID class.
     * @return A Class which inherits <code>SerializedGraphElement</code> and
     *         overrides <code>createVid</code> to return the correct vertex ID class.

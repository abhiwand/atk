...
cumulative_sum_frame = frame.cumulative_sum('a')
print(cumulative_sum_frame.inspect())

cumulative_count_frame = frame.cumulative_count('a', 1)
print(cumulative_count_frame.inspect())

cumulative_percent_sum_frame = frame.cumulative_percent_sum('a')
print(cumulative_percent_sum_frame.inspect())

cumulative_percent_count_frame = frame.cumulative_percent_count('a', 1)

 ...
 * except the <code>edgeReducerFunction</code> and the <code>vertexReducerFunction</code>.
 * <ul>
 *      <li><code>edgeSet</code>                Hashtable with the current list of merged edges.</li>
 *      <li><code>vertexSet</code>              Hashtable with the current list of merged vertices.</li>
 *      <li><code>edgeReducerFunction</code>    Optional edge reducer function.</li>
 *      <li><code>vertexReducerFunction</code>  Optional vertex reducer function.</li>
 *      <li><code>vertexLabelMap</code>         List of vertex labels to be used for writing rdf output.</li>
 *      <li><code>noBiDir</code>                Are we cleaning bidirectional edges. If true then remove bidirectional edge.</li>
 * </ul>
 * </p>
 */
public class GraphElementMerge implements GraphElementTypeCallback {
     ...
     *      <li><code>edgeReducerFunction</code>    Optional edge reducer function.</li>
     *      <li><code>vertexReducerFunction</code>  Optional vertex reducer function</li>
     *      <li><code>vertexLabelMap</code>         A list of vertex labels to be used for writing rdf output</li>
     *      <li><code>noBiDir</code>                Are we cleaning bidirectional edges. If true then remove

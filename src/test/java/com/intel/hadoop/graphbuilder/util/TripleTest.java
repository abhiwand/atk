...
public class TripleTest {
	...
	public void testEqualsAndHash() throws Exception {
		...
		Triple<Integer, Integer, Integer> tripInts0 = new Triple(intObj1,
				intObj1, intObj1);
		Triple<Integer, Integer, Integer> tripInts0a = new Triple(intObj2,
				intObj2, intObj2);
		Triple<Integer, Integer, Integer> tripInts1 = new Triple(intDifferent,
				intObj1, intObj1);
		Triple<Integer, Integer, Integer> tripInts2 = new Triple(intObj1,
				intDifferent, intObj1);
		Triple<Integer, Integer, Integer> tripInts3 = new Triple(intObj1,
				intObj1, intDifferent);

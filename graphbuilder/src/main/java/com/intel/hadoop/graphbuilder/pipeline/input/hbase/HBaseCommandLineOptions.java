 ...
 * instead reference them through <code>CommonCommandLineOptions</code>. If you add any new option
 * names, make sure to also add them to <code>CommonCommandLineOptions</code>.
 *

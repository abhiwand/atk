...
public class PropertyMap implements Writable
{
    ...
    /**
     * Default constructor. Allocates the underlying <code>MapWritable</code>.
     */
    public PropertyMap() {
    ...
    /**
     * Convert the <code>PropertyMap</code> to a <code>String</code>
     *
     * @return String representation of the <code>PropertyMap</code>
     */

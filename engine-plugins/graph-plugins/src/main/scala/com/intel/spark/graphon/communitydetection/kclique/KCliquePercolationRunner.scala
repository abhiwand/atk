...
//        case a: Any => e.tailPhysicalId.asInstanceOf[Long]
//        case null => e.tailVertexGbId.value.asInstanceOf[Long]
//      }
//
//    val destId =
//      e.headPhysicalId match {
//        case a: Any => e.headPhysicalId.asInstanceOf[Long]
//        case null => e.headVertexGbId.value.asInstanceOf[Long]
//      }
//    srcId < destId).map(e => datatypes.Edge(srcId,destId)))
//  }
//}

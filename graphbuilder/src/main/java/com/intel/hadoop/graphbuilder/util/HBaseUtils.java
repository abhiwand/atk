...
public class HBaseUtils {
    ...
    /**
     *  Returns the unique instance of <code>HBaseUtils</code>; creates one if there isn't one already.
     *
     *  @throws IOException
     *
     */
    ...
    /**
     * Returns the configuration of the <code>HBaseUtils</code> instance.
     * @return The configuration of the <code>HBaseUtils</code> instance.
     */

...
/**
 * The EdgeKey class is used in the CreateGraphReducer to detect and handle duplicate edges.
...
public class EdgeKey {
    ...
    /**
     * @param val
     *          the new value for the destination.
     */

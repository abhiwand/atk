...
object CommandDumperConfig extends EngineConfig {
  override val metaStoreConnectionUrl: String = nonEmptyString("intel.taproot.analytics.metastore.connection-h2.url")
  override val metaStoreConnectionDriver: String = nonEmptyString("intel.taproot.analytics.metastore.connection-h2.driver")
  override val metaStoreConnectionUsername: String = config.getString("intel.taproot.analytics.metastore.connection-h2.username")
  override val metaStoreConnectionPassword: String = config.getString("intel.taproot.analytics.metastore.connection-h2.password")
}

"""
Copy/paste from custom-parsers/shaw_udfs.py, because there is a @outputSchema annotation for pig in that file and currently I don't know of a way
 to move that pig-specific annotation into another file and have a pure custom python parser in a separate file.
"""
#### USER PARSING LOGIC #####
import re

...
class RenameFramePlugin extends SparkCommandPlugin[RenameFrame, DataFrame] {
   ...
   */
  override def execute(invocation: SparkInvocation, arguments: RenameFrame, returnValue: Option[DataFrame])(implicit user: UserPrincipal, executionContext: ExecutionContext): DataFrame = {

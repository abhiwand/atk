...
class ColumnProfile(object):
    ...
    >>> unique_value_optimization is True by default - by which we assume
    ...
    >>> many doubles with large precision), unique_value_optimization
    >>> can be passed as False for all computation to work via disk-based map-reduce
    >>> bc1 = ColumnProfile(data_intervals=interval_list, unique_value_optimization=False)
    """
    def __init__(self, **kwargs):
        ...
        self.in_memory_computation = kwargs.get('unique_value_optimization', True)
